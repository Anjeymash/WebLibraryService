...
<body>
			...
			<div class="row">
				...
				<div class="navbar-header">
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="https://www.linkedin.com/in/andrey-mashkouski-6079a7101"><fmt:message key="label.about" />
						</a></li>
						<li><a href="https://www.linkedin.com/in/andrey-mashkouski-6079a7101"><fmt:message key="label.contacts" />
						</a></li>
	...
	<div class="navbar navbar-cent">
		<div class="container">
			<div class="navbar navbar-cent">
				<h1><fmt:message key="label.books" /></h1>
			</div>
											...
											<div class="col-md-7">
												<p>
													<img
														...
														width="350" height="100" class="img-thumbnail">
				...
				<c:if test="${not empty requestScope.listbook }">
					...
					<table class="table">
						...
						<c:forEach var="book" items="${requestScope.listbook}">
							<tr>
								<td><img src="img/ch.jpg" width="100" height="100"
								...
								</a><a href="${editLink}"><button type="submit"
											class="btn btn-success">
											<fmt:message key="label.editbook" />
										</button></a> <a href="${delLink}"
